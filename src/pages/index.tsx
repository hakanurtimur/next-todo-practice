  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-900 to-secondary-900 flex flex-col justify-center items-center p-8 text-white">
      ...
      <p className="text-lg mb-8 text-center">
        Next Todo App is your ultimate task management solution. Stay organized
        and boost your productivity effortlessly.
      </p>
      <div className="text-lg mb-8 text-left">
        ...
        <ul className="list-disc ml-4">
          ...
          <li>
            Access your to-do list from any device with an internet connection.
          </li>
        </ul>
      </div>
      <Link
        href="/auth"
        className={
          ' "bg-yellow-400 hover:bg-yellow-500 text-gray-800 py-2 px-4 rounded-full text-lg font-semibold transition duration-300 ease-in-out"'
        }
      >
        Get Started
      </Link>
